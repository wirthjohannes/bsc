...
import Id
import PreIds(idTAdd, idTSub, idTMul, idTDiv, idTDivF, idTLog, idTExp, idTMax, idTMin)
import Util(divC, divF, log2)
...
opNumT i [x, y] | i == idTDivF && y /= 0 = Just (divF x y)
...
numOpNames :: [Id]
numOpNames = [idTAdd, idTSub, idTMul, idTDiv, idTDivF, idTExp, idTLog, idTMax, idTMin]
